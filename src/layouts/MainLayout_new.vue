        ...
        <q-scroll-area class="fit" :horizontal-thumb-style="{ opacity: 0 }">
          <q-list padding>
            ...
            <q-item clickable v-ripple @click="listado">
              ...
              <q-item-section>
                <img v-if="co_rol === '3'" :src="logo_sede" onerror="this.src='logo_impredigital.jpg'" width="150" />
                <img v-if="co_rol === '1'" src="logo_impredigital.jpg" width="150" />
                <img v-if="co_rol === '2'" src="logo_seniat.png" width="150" />
              </q-item-section>
            </q-item>
          </q-list>
        </q-scroll-area>
